...
### what's in my blood?
The treatment for my breast cancer entailed a difficult and long chemotherapy period, with a cycle of weekly sessions for 12 weeks, and a cycle of biweekly sessions for 8 weeks.
...
I did this for the course of several weeks, added the data to Flourish (a data visualization platform), and made this chart:
...
The chart shows on the x-axis the date of my blood run, and on the y-axis the values of the hemoglobin (line above) and the absolute neutrophil count (line below).  
I'll walk you through some key data points.

The 8th of November 2023 I started chemotherapy: this is where the measurements begin, right before my first chemotherapy session. Back then, my hemoglobin was 12 and a half and my absolute neutrophil count more than 7000. 
...
Between February and March 2024 I got an infection via my port-a-cath: you can see my neutrophil count spiking back to 6000, a clear sign that my poor body was definitely doing its best to protect me. And spectacularly failing. 

---

The [data are here](/data/blood-data.csv) if you want to have a look or perhaps recreate my chart - not sure why you'd want to do that, but you absolutely can. I am looking for a way to transform this plot into something more artsy, a landscape, a road, a collage, I am not sure. 

you have an idea? [let me know](mailto:paola.masuzzo@gmail.com) :)